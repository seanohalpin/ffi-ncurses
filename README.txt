...
There's no way (so far) to access (per process) global variables in
DLLs (hence the hack to stash +stdscr+).
...
getsx" as a search term. Not one for "I'm Feeling Lucky".
